...
# --- OPENAI API KEY ---
openai.api_key = "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"

# --- STREAMLIT PAGE SETUP ---
st.set_page_config(page_title="Gaurav's News to LinkedIn Generator", layout="wide")
st.markdown(
    """
    <style>
    body {
...
"""
    ...
    for style, prompt in styles.items():
        try:
            ...
            responses[style] = response['choices'][0]['message']['content'].strip()
